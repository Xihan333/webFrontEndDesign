...
<img src="https://cdn.jsdelivr.net/gh/rainnn-w/Pictures@main/blog/202312311614099.png" alt="时序图2（删，以成就界面为例）" style="zoom: 33%;" />

<img src="https://cdn.jsdelivr.net/gh/rainnn-w/Pictures@main/blog/202312311614292.png" alt="时序图3（查，以成就管理界面为例）" style="zoom: 33%;" />

<img src="https://cdn.jsdelivr.net/gh/rainnn-w/Pictures@main/blog/202312311615376.png" alt="时序图1（增或改，以成就界面为例）" style="zoom: 33%;" />

#### （3）类图

![类图](https://cdn.jsdelivr.net/gh/rainnn-w/Pictures@main/blog/202312311615518.png)
...
- 许新鑫（202200300219）
  - 前端教师端教师论文界面
  2.	前端管理员端教师管理、学生管理界面
  3.	前端管理员端互评管理的界面，学生端学生互评实现查看并评价本班同学、查看我的评论以及历史评论的界面的实现
  4.	前端学生端课外活动的界面
  5.	前端管理员端班级管理界面的实现、以及查看没有班级的同学并对及分配班级的功能
  6.	项目报告中部分图表的绘制
...
- 管理员端
  ...
  1. 学科管理界面
     ...
     <img src="https://cdn.jsdelivr.net/gh/Xihan333/imgRep/202312311515435.png" alt="image-20231231151548355" style="zoom:50%;" />
...
<img src="https://cdn.jsdelivr.net/gh/rainnn-w/Pictures@main/blog/202312311546385.png" alt="image-20231231154620267" style="zoom:50%;" />
...
图片验证码由4位随机数字组成，样例及代码如下<img src="https://cdn.jsdelivr.net/gh/rainnn-w/Pictures@main/blog/202312311548979.png" alt="image-20231231154813849" style="zoom: 25%;" />
