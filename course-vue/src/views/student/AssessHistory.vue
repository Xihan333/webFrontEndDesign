...
<template>
    <div class="assess-history">
        ...
        <el-table border
            ...
            style="width: 100%">
            <el-table-column prop="student.person.name" label="被评人姓名" width="auto" align="center"/>
            <el-table-column prop="student.person.num" label="被评人学号" width="auto" align="center"/>
