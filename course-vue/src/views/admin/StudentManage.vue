...
<template>
    <div class="student-manage">
        <div>
            <StudentManageDialog v-model:show="show" :rowData="currentRowData" :dialogMode="dialogMode" @updateTable="updateTableData" />
        ...
        <el-table border
            ...
            <el-table-column prop="num" label="学号" width="230" align="center"/>
            <el-table-column prop="genderName" label="性别" width="90" align="center"/>
            <el-table-column prop="card" label="身份证号" width="280" align="center"/>
            <el-table-column prop="dept" label="专业" width="150" align="center"/>
