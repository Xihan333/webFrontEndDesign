...
<template>
    <div class="achievement-audit">
      <div>
        ...
        <AchievementDialogAdmin v-model:show="show" :rowData="currentRowData" :dialogMode="dialogMode" @updateTable="updateTableData" />
        <!-- 查询部分 -->
        <div class="query">
          <el-input
              clearable
      ...
      <el-table border
        ...
        style="width: 100%">
          ...
          <el-table-column prop="type" label="成就类别" width="250" align="center"/> 
          <el-table-column prop="level" label="成就级别" width="280" align="center"/> 
          <!-- 时间 -->
          <el-table-column sortable prop="time" label="时间" width="280" align="center"/>   
          ...
          />
          <el-table-column label="操作" width="280" text-align="center">
            <!-- 操作部分，根据需要修改 -->
    ...
    //引入弹窗页面
    import AchievementDialogAdmin from '../../components/AchievementDialogAdmin.vue'
    ...
    const updateTableData = async () => {
      const res = await request.post('/achievement/getAchievementList',{
        data:{
          numName:""
        } 
      })
