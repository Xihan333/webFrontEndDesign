...
import org.fatmansoft.teach.service.TeacherIntroduceService;
...
public class TeacherController {
    ...
    public DataResponse getTeacherIntroduceData(@Valid @RequestBody DataRequest dataRequest) {
        ...
        data.put("info",info);
        data.put("familyList",familyService.getFamilyMapListByTeacherId(s.getTeacherId()));
        data.put("educationExperienceList",educationExperienceService.getTeacherEducationExperienceMapList((s.getTeacherId())));
