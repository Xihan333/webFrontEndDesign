...
public class ScientificPayoffsController {
    ...
    @PostMapping("/getStudentScientificPayoffs")
    @PreAuthorize("hasRole('ROLE_STUDENT')")
    public DataResponse getStudentScientificPayoffs(@Valid @RequestBody DataRequest dataRequest) {
        ...
        List dataList = scientificPayoffsService.getScientificPayoffsMapListByStudentId(studentId);
    ...
    @PostMapping("/scientificPayoffsStudentEditSave")
    @PreAuthorize("hasRole('ROLE_STUDENT')")
    public DataResponse scientificPayoffsStudentEditSave(@Valid @RequestBody DataRequest dataRequest) {
        Integer scientificPayoffsId = dataRequest.getInteger("scientificPayoffsId");  //获取scientificPayoffs_id值
        Map form = dataRequest.getMap("form"); //参数获取Map对象
        String day = CommonMethod.getString(form,"day");
        String identity = CommonMethod.getString(form,"identity");
